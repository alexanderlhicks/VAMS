...
CORE_PEER_GOSSIP_EXTERNALENDPOINT=agent:7051 \
CORE_PEER_GOSSIP_USELEADERELECTION=true \
CORE_PEER_GOSSIP_ORGLEADER=false \
CORE_PEER_TLS_ENABLED=false \
CORE_PEER_TLS_KEY_FILE=/home/ubuntu/verifiable-access-code/hlf-11preview/crypto-config/peerOrganizations/Agents/users/Admin@Agents/tls/server.key \
CORE_PEER_TLS_CERT_FILE=/home/ubuntu/verifiable-access-code/hlf-11preview/crypto-config/peerOrganizations/Agents/users/Admin@Agents/tls/server.crt \
