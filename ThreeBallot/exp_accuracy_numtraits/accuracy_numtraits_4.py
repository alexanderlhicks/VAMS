...
lst_lst_traits = []
lst_lst_traits.append(['F0','F2','F5','F9'])
lst_lst_traits.append(['F0','F2','F4','F5'])
lst_lst_traits.append(['F2','F4','F5','F9'])
lst_lst_traits.append(['F2','F4','F5','F6'])
...
for index,lst_traits in enumerate(lst_lst_traits):
    ...
    for iter in range(100): #Experiment repeat
        ...
        with open("../results//num_of_traits//" + '-'.join(lst_traits)+"_4.csv", "a+") as results:
