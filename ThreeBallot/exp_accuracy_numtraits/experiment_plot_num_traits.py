...
data_1000 = pandas.read_csv('../results//num_of_traits//merged_2.csv', sep=',', na_values='.')
data_10000 = pandas.read_csv('../results//num_of_traits//merged_3.csv', sep=',', na_values='.')
data_100000 = pandas.read_csv('../results//num_of_traits//merged_4.csv', sep=',', na_values='.')
data_1000000 = pandas.read_csv('../results//num_of_traits//merged_5.csv', sep=',', na_values='.')
...
ax.legend(handles, ["2 Traits", "3 Traits", "4 Traits", "5 Traits"])

plt.savefig("../results//num_of_traits//plots//support.pdf", bbox_inches='tight')
plt.show()
