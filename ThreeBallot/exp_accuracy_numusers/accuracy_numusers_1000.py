...
lst_lst_traits = []
lst_lst_traits.append(['F13','F5'])
lst_lst_traits.append(['F4','F9'])
lst_lst_traits.append(['F1','F11'])
lst_lst_traits.append(['F1','F4'])
lst_lst_traits.append(['F1','F10'])
...
for index,lst_traits in enumerate(lst_lst_traits):
    ...
    ds = {}
    raw_data = open('../datasets/synthetic/varying_users/0.9_tsz14_tct1.0k.txt')
    ...
    for iter in range(100): #Experiment repeat
        ...
        with open("../results//num_of_users//" + '-'.join(lst_traits)+"_1000.csv", "a+") as results:
