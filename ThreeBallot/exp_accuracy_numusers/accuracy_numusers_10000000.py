...
lst_of_proportions = ['0.1','0.3','0.5','0.7','0.9']

lst_lst_traits = []
lst_lst_traits.append(['F13','I20'])
lst_lst_traits.append(['F13','F9'])
lst_lst_traits.append(['F16','F8'])
lst_lst_traits.append(['F16','F3'])
lst_lst_traits.append(['F16','F9'])
...
for index,lst_traits in enumerate(lst_lst_traits):
    ...
    ds = {}
    raw_data = open('../datasets/synthetic/varying_users/0.99_tsz20_tct1.0m.txt')
    ...
    for iter in range(100): #Experiment repeat
        ...
        with open("../results//num_of_users//" + '-'.join(lst_traits)+"_1000000.csv", "a+") as results:
