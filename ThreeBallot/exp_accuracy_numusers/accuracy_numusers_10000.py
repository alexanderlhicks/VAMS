...
lst_lst_traits = []
lst_lst_traits.append(['F12','F8'])
lst_lst_traits.append(['F0','F8'])
lst_lst_traits.append(['F0','F3'])
lst_lst_traits.append(['F0','F6'])
lst_lst_traits.append(['F2','F6'])
...
for index,lst_traits in enumerate(lst_lst_traits):
    ...
    ds = {}
    raw_data = open('../datasets/synthetic/varying_users/0.9_tsz14_tct10.0k.txt')
    ...
    for iter in range(100): #Experiment repeat
        ...
        with open("../results//num_of_users//" + '-'.join(lst_traits)+"_10000.csv", "a+") as results:
