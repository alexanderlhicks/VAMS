...
lst_lst_traits = []
lst_lst_traits.append(['F0','F9'])
lst_lst_traits.append(['F1','F2'])
lst_lst_traits.append(['F2','F8'])
lst_lst_traits.append(['F2','F5'])
lst_lst_traits.append(['F2','F4'])
...
for index,lst_traits in enumerate(lst_lst_traits):
    ...
    ds = {}
    raw_data = open('../datasets/synthetic/varying_users/0.99_tsz10_tct100.0k.txt')
    ...
    for iter in range(100): #Experiment repeat
        ...
        with open("../results//num_of_users//" + '-'.join(lst_traits)+"_100000.csv", "a+") as results:
